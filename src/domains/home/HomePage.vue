...
const normalizeStore = (store) => {
  const batterySupported = store.isBatterySupported ?? false

  return {
    id: store.storeId,
    name: store.businessName,
    category: store.foodCategoryNames || '카테고리 미정',
    region: store.addrBase || '지역 미정',
          ...
          <div v-else class="featured-grid">
            ...
            >
              ...
              <div class="store-body">
                ...
                <button class="store-link store-link--disabled" type="button" disabled>
                  상세 기능 준비 중
                </button>
              </div>
            </article>
